...
- (BOOL)canUseCachedDataForRequest:(ASIHTTPRequest *)request
{
    ...
    // fix bug: crash when X-ASIHTTPRequest-Response-Status-Code is 302
    NSString* statusCode = [headers objectForKey:@"X-ASIHTTPRequest-Response-Status-Code"];
    if (!statusCode
        || [statusCode intValue] != 200)
        return NO;
