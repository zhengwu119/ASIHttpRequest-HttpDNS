...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
	...
	NSURL *url; 
	// The domain of url was translated by DNSPod
    NSString *ip;
...
@property (assign) BOOL useHTTPDNS;
...
@property (retain,readonly,nonatomic) NSString *ip;
@property (assign,readonly,nonatomic) NSInteger port;
@property (retain) NSURL *originalURL;
@property (weak, nonatomic) id delegate; // weak set delegate nil if delegate is dealloced,
